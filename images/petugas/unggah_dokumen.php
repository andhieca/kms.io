                        ...
                        <br/>
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="unggah_dokumen_proses.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_dokumen">Judul dokumen <span class="required"></span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">   
                                                <input type="text" id="nama_dokumen" name="nama_dokumen" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_kategori">Kategori dokumen <span class="required"></span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control" name="id_kategori" id="id_kategori" required>
                                            <option selected="selected" disabled="disabled" value="">Pilih Kategori Pengetahuan</option>
                                            <?php
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                ...
                                                <a href="index.php?page=unggah_dokumen_sukses"><button type ="submit" class="btn btn-success">Unggah</button></a>
                                            </div>
                                        </div>
