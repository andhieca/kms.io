                                            ...
                                            <div id="crop-avatar">
                                                ...
                                                <div class="avatar-view" title="Change the avatar">
                                                    <?php
                                                        if($data['foto']==NULL){
                                                    ?>
                                                            <img src="../../images/user.png" alt="avatar" class="img-responsive img-thumbnail" />
                                                    <?php
                                                        }else{
                                                    ?>
                                                            <img src="<?php echo $data['foto'];?>" alt="avatar" class="img-responsive img-thumbnail"/>
                                                    <?php
                                                        }
                                                ...
                                                <!-- Loading state -->
                                                <div class="loading" aria-label="Loading" role="form" tabindex="-1"></div>
                                            </div>
                                            <!-- end of image cropping -->
