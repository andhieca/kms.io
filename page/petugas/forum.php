                        ...
                        <table id="example" class="table table-striped responsive-utilities jambo_table">
                            <thead>
                                  <?php
                                        ...
                                        $tampil=mysql_query("select t_forum.id_forum, t_forum.judul_forum, t_forum.nip, t_forum.isi_forum ,t_forum.tanggal_post, t_pengguna.nama_pengguna, t_pengguna.foto from t_forum, t_pengguna where t_forum.nip = t_pengguna.nip ORDER BY t_forum.tanggal_post DESC",$link);
