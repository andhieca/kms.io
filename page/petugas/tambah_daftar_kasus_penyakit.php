                                    ...
                                    <div id="wizard" class="form_wizard wizard_horizontal">
                                        ...
                                        <div id="step-1">
                                            ...
                                            <?php
                                                ...
                                                $sqlAtribut="SELECT t_atributgejala.`id_atribut_gejala`,
                                            ...
                                            ?>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                         <input type="checkbox" name="id_atribut_gejala_<?php echo $i;?>" value="<?php echo $id_atribut_gejala;?>" class="minimal-red checkbox-gejala" if()/>
