...
$query2 = mysql_query("INSERT INTO  t_histori_penanganan  (id_lesson_learned, no_anggota, nama_anggota,alamat_anggota,tanggal_penanganan, nomor_telinga, nama_sapi, jenis_penanganan)
	VALUES ('$last_id','$no_anggota', '$nama_anggota', '$alamat_anggota','$tanggal_penanganan_fix','$nomor_telinga','$nama_sapi','$jenis_penanganan')");
if ($query2){
