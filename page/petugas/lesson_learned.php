                       ...
                       <center><a href="index.php?page=tambah_lesson_learned"><button type="button" class="btn btn-round btn-success btn-lg" ><i class="fa fa-plus-square"> Tambahkan Lesson Learned </i></button></a></center>
                        <table id="example" class="table table-striped responsive-utilities jambo_table">
                            ...
                            <?php
                                        ...
                                        $tampil=mysql_query("SELECT * FROM t_lesson_learned, t_pengguna, t_histori_penanganan where t_pengguna.nip=t_lesson_learned.nip and t_lesson_learned.id_lesson_learned=t_histori_penanganan.id_lesson_learned",$link);
