            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        $querylesson =mysql_query("SELECT * FROM t_lesson_learned, t_pengguna, t_histori_penanganan, t_kategori where t_pengguna.nip=t_lesson_learned.nip and t_lesson_learned.id_lesson_learned=t_histori_penanganan.id_lesson_learned and t_histori_penanganan.id_kategori=t_kategori.id_kategori and t_lesson_learned.id_lesson_learned='$id_lesson_learned'",$link);
                        ...
                        ?>
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="tambah_daftar_kategori_proses.php" method="POST">
                                        ...
                                        <strong>Kategori Penanganan : <?php echo $data['nama_kategori'];?></strong><br>
