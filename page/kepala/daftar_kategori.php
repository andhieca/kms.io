                                    ...
                                    <td>
                                     ...
                                     <td align="center">
                                            <a href="index.php?page=ubah_kategori&&id_kategori=<?php echo $data['id_kategori'];?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Ubah </a> | 
                                              <a href="hapus_kategori.php?id_kategori=<?php echo $data['id_kategori'];?>" class="btn btn-danger btn-xs" onclick ="if (!confirm('Apakah Anda yakin akan menghapus data kategori <?php echo $data['nama_kategori'];?>?')) return false;"><i class="fa fa-remove"></i> hapus </a>
