                                    ...
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="tambah_lesson_learned_proses.php" method="POST">
                                        ...
                                        <hr>
                                         <h2>Keterangan Hasil Penanganan</h2>
                                          <textarea class="form-control textarea" name="keterangan" rows="5" required="true" oninvalid="check(this)" x-moz-errormessage="Field ini tidak boleh kosong" placeholder="Keterangan" ></textarea>
                                        <div class="form-group">
                                            <br>
