                    ...
                    <div class="x_content">
                        <br/>
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="tambah_daftar_atribut_gejala_proses.php" method="POST">
                                        <?php
                                            $query=mysql_query("SELECT COUNT(id_atributgejala)+1
                                                                    FROM t_atributgejala
                                                                    WHERE id_atributgejala LIKE '%G%'");
                                            $dataJumlah=mysql_fetch_array($query);

                                            $atribut = $dataJumlah['COUNT(id_atributgejala)+1'];
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <input type="text" id="id_atributgejala" name="id_atributgejala" value="<?php echo "G".$nomor_urut ?>" class="form-control col-md-7 col-xs-12" readonly >
                                            </div>
                                        </div>
                                        <div class="form-group">
