                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <?php
                            ...
                            $query=mysql_query("SELECT * FROM t_atributgejala WHERE id_atributgejala='$id_atributgejala'");
                        ...
                        ?>
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="ubah_daftar_atribut_gejala_proses.php" method="POST">
                                        <input type="text" id="id_atributgejala" name="id_atributgejala" required="required" style="display:none" class="form-control col-md-7 col-xs-12" value="<?php echo $data['id_atributgejala'];?>">
