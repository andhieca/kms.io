                                    ...
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="tambah_forum_proses.php" method="POST">
                                        ...
                                        ?>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <option selected="selected" disabled="disabled" value="">Pilih Kategori forum...</option>
                                            <?php
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                ...
                                                <a href="index.php?page=tambah_forum_sukses"><button type ="submit" class="btn btn-success" onclick="return confirm('Simpan data?')">Simpan</button></a>
                                            </div>
                                        </div>
